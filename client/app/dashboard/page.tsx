...
import { Plus, Calendar, BarChart3, Clock, Bell, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-secondary)" }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* Welcome Banner */}
        <div
          className="rounded-2xl p-6 sm:p-8 mb-6 gradient-mesh border animate-fade-in"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <Link
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border transition-all btn-active"
                style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Widget title="Today's Schedule" icon={<Clock className="h-4 w-4" />}>
            ...
            <Widget title="Overdue" icon={<Bell className="h-4 w-4" />}>
